...
import net.citizensnpcs.api.abstraction.Enchantment;
import net.citizensnpcs.api.abstraction.ItemStack;
import net.citizensnpcs.api.abstraction.Material;
import net.citizensnpcs.api.abstraction.SimpleItemStack;

public class ItemStorage {

    public static ItemStack loadItemStack(DataKey root) {
        Material matched = Material.match(root.getString("id"));
        if (matched == null)
            return null;
        ItemStack res = new SimpleItemStack(matched, root.getInt("amount"),
